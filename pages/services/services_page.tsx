...
export default function ServicesPage() {
    ...
    return <div className="pt-9 mx-auto z-10 flex flex-col items-center max-[1500px]:justify-center w-full h-full" style={{ overflow: 'hidden', maxWidth: "1980px" }}>

        <div
            className="z-[-1] mx-auto absolute left-0 right-0 h-full"
            style={{
                // height: "3000px",
        ...
        <div className="h-full w-full z-20 flex flex-wrap justify-center items-start gap-[100px]">
            ...
            <div className="text-start flex flex-col max-[1500px]:text-center justify-start max-[1500px]:justify-center items-center">
                ...
                <div className="relative">
                    ...
                    <div className={`${styles.shapeSize} ${styles.setPadding} rounded-2xl text-start bg-white items-start`} style={{ ...setPosition("", 400, 100, ""), ...setPadding(16, 20, 16, 20), ...setBox("", 265), boxShadow: "0px 1px 50px #00000010" }}>
                        ...
                        <p className={`${styles.f16} font-normal ${styles.marginSize} text-[#364F65]`} style={{ ...setMargin(0, 0, 0, 10) }}>Total Students</p>
                        <p className={`${styles.f36} font-medium ${styles.marginSize} text-[#364F65]`} style={{ ...setMargin(0, 0, 0, 10) }}>93</p>
